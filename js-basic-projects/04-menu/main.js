...
const categoryOption = document.querySelectorAll('.menu__category-option');
const categoryBtn = document.querySelectorAll('.menu__category-btn');
...
function drawData (option) {
  menuInner.innerHTML = '';

  menuList.forEach(item => {
    if (!option || option === 'all' || item.category === option) {
      menuInner.innerHTML += `
        <div class="menu__item">
          ...
          <div class="menu__item__info">
            <div class="menu__item-detail">
              <h2 class="menu__name">${item.title}</h2>
